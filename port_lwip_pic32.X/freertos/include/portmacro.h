...
#ifndef _PIC32_PORTMACRO_H_
#define _PIC32_PORTMACRO_H_
...
#define portTICK_TRACE_PERIOD_uS        	( ( TickType_t ) 1000000 / configTICK_TRACE_RATE_HZ )
/*-----------------------------------------------------------*/
